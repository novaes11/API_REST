...
Esta é uma API RESTful simples desenvolvida em Node.js com Express para o gerenciamento de um catálogo de filmes em memória (Mock DB). 

## ✅ Requisitos do Projeto
- **[x] Todos os endpoints funcionando:** CRUD 100% implementado (GET, POST, PUT, DELETE).
- **[x] Status codes corretos:** Utilização rigorosa de `200`, `201`, `400`, `404` e `500`.
- **[x] Validação de dados:** Payload sendo checado (Campos vazios, Tipagem incorreta e Regras de negócio).
- **[x] README.md com documentação:** Documentação de todos os endpoints e testes.
- **[x] Git com commits organizados:** Utilização do padrão *Conventional Commits*.
- **[x] Código comentado e limpo:** Uso de `try/catch`, responsabilidades separadas e documentação via *JSDoc*.
...
> ![Print do Postman mostrando o PUT 200 OK][def]
...
[def]: ./pictures/PUTDEPOIS_print.PNG